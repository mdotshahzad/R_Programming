...
mymat <- matrix(seq(2,18, by =2),nrow=3,ncol=3)
mymat
...
my_fact <- factor(c("Employed","Unemployed","Self-Employed","Self-Employed","Employed","Unemployed","Unemployed","Employed"))
...
bank_customers <- data.frame( CustomerID = 1:5, hasAccount= c(F,T,T,T,F), totalBalance = c(NA,10000,10,2000,NA)  )
